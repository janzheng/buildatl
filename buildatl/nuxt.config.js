...
const site_ga = 'UA-116553139-3' 
const site_url = 'http://buildatl.com'
const site_name = 'buildatl';
const site_twitter = '@buildatl';
const site_twitter_creator = '@janistanian';
const site_color = '#FFDF0A';
const site_title = 'keep Atlanta awesome';
const site_description = 'buildatl pairs professionals with social good projects and organizations around Atlanta';

const site_ico = '/atl_ico.png';
const site_image = '/atl_img.png';
